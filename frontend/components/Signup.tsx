...
const IPL_TEAM_COLORS:any = {
    red: {
        name: 'Royal Challengers Bangalore',
        shortName: 'RCB',
        color: '#ff0000',
        logo: 'https://example.com/rcb-logo.png' // Replace with actual logo URLs
    },
    blue: {
        name: 'Mumbai Indians',
        shortName: 'MI',
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
            ...
            <div className="relative bg-transparent rounded border-s-2 border-t-2 border-slate-800 bg-opacity-50 backdrop-blur-md p-8 rounded-xl shadow-2xl w-96">
                <h2 className="text-2xl flex justify-center font-mono font-bold text-center text-white mb-6">Signup
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <button
                            ...
                            className={`w-full px-4 py-2 rounded-lg border transition-all duration-300 ${formData.color
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                        <div className="bg-gray-900 rounded-xl p-6 max-w-md w-full max-h-[80vh] overflow-y-auto">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {Object.entries(IPL_TEAM_COLORS).map(([colorKey, teamInfo]:any) => (
                                    <button
                                        key={colorKey}
